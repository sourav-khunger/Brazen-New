...
class RTCVideoChatViewController: UIViewController,RTCEAGLVideoViewDelegate,ARDAppClientDelegate {
    ...
    @IBOutlet weak var mapTopView: MKMapView!
    ...
    override func viewDidLoad()
    {
        ...
        self.mapTopView.showAnnotations([annotaion], animated: true)
    }
    ...
    @IBAction func hangupButtonPressed(_ sender:UIButton){
        ...
        if !called {
            ...
            if #available(iOS 10.0, *) {
                let vc = self.storyboard?.instantiateViewController(withIdentifier: "SplashController") as! SplashController
    ...
    func appClient(_ client: ARDAppClient!, didReceiveRemoteVideoTrack remoteVideoTrack: RTCVideoTrack!) {
        ...
        UIView.animate(withDuration: 0.4, animations: { () -> Void in
            self.localViewBottomConstraint?.constant=25.0
            self.localViewRightConstraint?.constant=25.0
